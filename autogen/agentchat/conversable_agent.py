...
__all__ = ("ConversableAgent", "AgentCallbackHandlerType")
...
class ConversableAgent(Agent):
    ...
    async def a_generate_oai_reply(
        ...
        for message in messages:
            ...
            if tool_responses:
                ...
                if message.get("role") != "tool":
                    all_messages.append(
                        {key: message[key] for key in message if
                         key != "tool_responses"})
            else:
                all_messages.append(message)
        ...
        extracted_response = \
        client.extract_text_or_completion_object(response)[0]
    ...
    def generate_code_execution_reply(
        ...
        code_execution_config = config if config is not None \
            else self._code_execution_config
